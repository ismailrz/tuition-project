...
<input type="password" class="form-control" name="password" placeholder="Password" onfocusout="password_match()"  id="password" required>
<input type="password" class="form-control" name="Confirmpassword" placeholder="Confirm password" onfocusout="password_match()"  id="con_password" required >
...
<input type="text" class="form-control" name="subject" placeholder="prefer Subjects(such as Math,Physics,English)" id="" required>
</select>
