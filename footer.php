...
if(isset($_POST['btn'])){
	...
	try{
			if(mail("alamincse039@gmail.com","Tuitionoffer.com",$msg)){
                    ...
                    <div class="footerSection">
                            ...
                            <div class="footerContent">
                                <table>
                                    <tr>
                                        ...
                                        <td> 01738088967 OR 01743557172</td>
                                        
                                    </tr>
                                    <tr>
                                        <td><i class="fa fa-envelope"></i> </td>
                                        <td> <b> tuitionoffer@gmail.com</b></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                        ...
                        <div class="footerContentPart">
                            ...
                            <div class="footerContent">
                                <table>
                                    <tr>
                                        <td><a href="https://www.facebook.com"><i class="fa fa-facebook-square"></i>  Facebook</a></td>
                                    </tr>
                                    <tr>
                                        <td><a href="https://twitter.com"><i class="fa fa-twitter-square"></i>  Twitter</a></td>
                                    </tr>
                                    
                                    <tr>
                                        <td><a href="https://www.linkedin.com"><i class="fa fa-linkedin"></i>  Linkedin </a></td>
                                    </tr>
